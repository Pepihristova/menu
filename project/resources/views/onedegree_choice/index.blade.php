...
<ul>
	...
	<form method="post" action="{{ action('MenuOptionsController@store', ['current_menu_price' => $price, 'menu_one_id' => $random->id, 'menu_two_id' => NULL, 'menu_three_id' => NULL, 'menu_four_id' => NULL ]) }}" >
					{{ csrf_field() }}
