...
<script type="text/javascript">
    function gotosite() {
        ...
        var pr = document.getElementById('budget').value;
        var num = document.getElementById('number').value;
         var e = document.getElementById("restaurant_id");
        var restaurant_id = e.options[e.selectedIndex].value;
        console.log(query+'?budget='+ pr +'?number=' + num+ '?restaurant_id='+ restaurant_id)
        var string_url = "?budget=" + pr + '&number=' + num +'&restaurant_id=' +restaurant_id ;
